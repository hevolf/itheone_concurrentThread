...
public class UseAtomicStampedReference {
    ...
    public static void main(String[] args) throws InterruptedException {
    	...
    	final String oldReferenc = asr.getReference();//初始值
			...
			public void run() {
				System.out.println(Thread.currentThread().getName()
						...
						+asr.compareAndSet(oldReferenc, oldReferenc+"Java",
								oldStamp, oldStamp+1));//oldStamp = 0 newStamp=1  交换后stamp=1
			...
			public void run() {
				...
				System.out.println(Thread.currentThread().getName()
						...
						+asr.compareAndSet(reference, reference+"C",
								oldStamp, oldStamp+1));//当前版本戳stamp=1  初始oldStamp=0，所以不执行交换更新
