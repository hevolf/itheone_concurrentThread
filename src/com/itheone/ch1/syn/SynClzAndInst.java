...
public class SynClzAndInst {
  ...
  //使用对象锁的线程
    private static class InstanceSyn implements Runnable{
        private com.itheone.ch1.syn.SynClzAndInst synClzAndInst;

        public InstanceSyn(com.itheone.ch1.syn.SynClzAndInst synClzAndInst) {
  ...
  //使用对象锁的线程
    private static class Instance2Syn implements Runnable{
        ...
        public Instance2Syn(com.itheone.ch1.syn.SynClzAndInst synClzAndInst) {
            this.synClzAndInst = synClzAndInst;
        }
        @Override
        public void run() {
    ...
    public static void main(String[] args) {
    	com.itheone.ch1.syn.SynClzAndInst synClzAndInst = new com.itheone.ch1.syn.SynClzAndInst();
